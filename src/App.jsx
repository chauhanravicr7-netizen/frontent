  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        <StatCard label="Total Volume" value={`${totalVolume} units`} icon="📊" color="green" />
        ...
        <StatCard label="Pending Payments" value={deals.filter(d => d.payment_status === "Pending").length} icon="⏳" color="purple" />
