    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="space-y-2 text-sm">
            {lowStock.length === 0 ? <p className="text-green-600">✅ All stock levels healthy</p> :
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="p-2 bg-orange-50 rounded-lg flex justify-between">
              ...
              <span className="font-bold text-orange-700">{deals.filter(d => (d.stage||d.status||"") === "draft").length}</span>
            </div>
            <div className="p-2 bg-blue-50 rounded-lg flex justify-between">
              <span className="text-gray-700">Completed</span>
              <span className="font-bold text-blue-700">{deals.filter(d => ["completed","delivered"].includes((d.stage||d.status||"").toLowerCase())).length}</span>
            </div>
          </div>
        </div>
      </div>
